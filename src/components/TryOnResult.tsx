...
export function TryOnResult({
    ...
    // Get all available images (results array or single result)
    const availableImages =
        result.results || (result.result ? [result.result] : []);
    const currentImage = availableImages[selectedImageIndex];

    const handleDownload = () => {
        if (!result.success || !currentImage) return;

        // Crear enlace de descarga directo
        const link = document.createElement("a");
        link.href = currentImage;
        const filename = `try-on-${productName}-v${selectedImageIndex + 1}-${Date.now()}.png`;
    ...
    const handleShare = async () => {
        ...
        try {
            ...
            if (currentImage.startsWith("data:")) {
                blob = dataURLtoBlob(currentImage);
            } else {
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    ...
                    {result.success && availableImages.length > 0 ? (
                        <div className="space-y-6">
                            ...
                            <div className="relative">
                                <div className="relative aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
                                    <Image
                                        key={selectedImageIndex} // Force re-render when image changes
                                        src={currentImage}
                                        alt={`Prueba virtual de ${productName} - Versión ${selectedImageIndex + 1}`}
                                        fill
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-green-700 mt-1">
                                            {availableImages.length > 1
                                                ? `Se generaron ${availableImages.length} versiones. Elige la que más te guste.`
                            ...
                            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <ul className="text-xs text-blue-700 space-y-1">
                                    <li>
                                        • Guarda la imagen para mostrarla a tus
                                        amigos
                                    </li>
                                    {availableImages.length > 1 && (
                                        <li>
                                            • Prueba las diferentes versiones
                                            usando las pestañas
                                        </li>
                                    )}
                                    <li>
                                        • Prueba diferentes poses para mejores
                                        resultados
                                    </li>
                                    <li>
                                        • Explora otros productos de nuestra
                                        colección
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                ...
                                <ul className="text-xs text-yellow-700 space-y-1">
                                    <li>
                                        • Asegúrate de que la imagen sea clara y
                                        bien iluminada
                                    </li>
                                    <li>
                                        • Usa una foto donde se vea claramente
                                        tu torso
                                    </li>
                                    <li>
                                        • Verifica que el archivo sea JPG, PNG o
                                        WebP
                                    </li>
                                    <li>
